...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28 border-b border-slate-200 bg-gradient-to-b from-white via-indigo-50/30 to-slate-50">
        {/* Subtle decorative background glow */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-200/40 rounded-full blur-3xl pointer-events-none -z-10" />

        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-indigo-50 border border-indigo-200/80 rounded-full px-4 py-1.5 mb-6 text-xs font-semibold text-indigo-800 shadow-xs">
          ...
          <p className="max-w-2xl mx-auto text-base sm:text-lg text-slate-600 leading-relaxed mb-8">
            ...
            <strong className="text-slate-800 font-semibold"> ProjectMatch AI</strong> uses explainable AI matching algorithms to evaluate hard skills, domain affinity, and schedule alignment — showing exactly <em>why</em> candidates fit.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-14">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-white hover:bg-slate-50 text-slate-800 text-base font-semibold px-7 py-3.5 rounded-xl border border-slate-300 shadow-xs transition-all duration-150 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center text-sm font-medium text-slate-600 hover:text-indigo-600 px-4 py-3 transition-colors cursor-pointer"
            >
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200/90 shadow-xl overflow-hidden text-left p-6 sm:p-7">
            <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-slate-100">
              ...
              <div className="bg-indigo-50 text-indigo-700 text-xs font-semibold px-2.5 py-1 rounded-md border border-indigo-100">
            ...
            <div className="mt-5 grid grid-cols-1 md:grid-cols-12 gap-5 items-center">
              ...
              <div className="md:col-span-7 space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-slate-900 text-base">Elena Rostova</h3>
                    <p className="text-xs text-slate-500">Senior · Data Science & Medical Imaging</p>
                  </div>
                </div>

                <div className="flex flex-wrap gap-1.5 pt-1">
                  <span className="bg-emerald-50 text-emerald-800 text-xs px-2 py-0.5 rounded-md font-medium border border-emerald-200">
                    PyTorch (Matches Req)
                  </span>
                  <span className="bg-emerald-50 text-emerald-800 text-xs px-2 py-0.5 rounded-md font-medium border border-emerald-200">
                    Computer Vision
              ...
              <div className="md:col-span-5 bg-slate-50 rounded-xl p-3.5 border border-slate-200/80">
                <div className="flex items-baseline justify-between mb-2">
                  <span className="text-xs font-semibold text-slate-600">Explainable Match</span>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            className="bg-white rounded-2xl p-7 border border-slate-200 shadow-sm hover:shadow-md transition-shadow relative group"
          >
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Team Gap Analysis</h3>
            <p className="text-slate-600 text-sm leading-relaxed mb-4">
      ...
      <section className="py-16 bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {/* Step 1 */}
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200/80 relative">
          ...
          {/* Bottom CTA Banner */}
          <div className="mt-14 bg-gradient-to-r from-slate-900 to-indigo-950 rounded-2xl p-8 text-white text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6 shadow-md">
            <div>
